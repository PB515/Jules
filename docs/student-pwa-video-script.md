...
Confirm the name, tap **Add**. Show the app icon landing on the home
screen.

**Say:**
> "On iPhone it's a bit different — there's no install button, that's
> normal. Open this same link in Safari, tap the Share icon at the bottom,
> scroll down, and tap 'Add to Home Screen.' Confirm, and it's on your
> home screen just like any other app."

**Callout to show on screen (text overlay):**
...
real student email/password, tap in.

**Say:**
> "Open it like any other app. Log in with the account your club gave
> you — you don't sign up yourself, your account is already created for
> you."

**End on:** the Dashboard loading.
...
chain, Upcoming Events, My Registered Events.

**Say:**
> "This is your Grid — your home screen. Your Synergy Points for this
> season, your tier, and your streak — how many events in a row you've
> actually shown up to. Below that: events you can register for, and the
> ones you're already signed up for."

**End on:** tapping one "Upcoming event" row.
...
too. Go back to the Dashboard, show the event now under "My Registered
Events."

**Say:**
> "Tap into any event to see the details and register. If your club needs
> extra info — like team size — it'll open their form right after. You'll
> get a reminder the day before, and if the venue changes last-minute,
> you'll know."
...
in-app. Show the success screen ("Checked in!" + points awarded).

**Say:**
> "At the event itself, scan the QR code the coordinator's showing —
> either with your regular camera app, or right inside Synergy. That's it,
> you're checked in and your points land immediately."
...
voiceover; nothing to demo live yet.*

**Show:** Tap the "Live" icon in the bottom nav, just enough to show the
room-code entry screen exists. No need to join or play anything.

**Say:**
> "One more thing worth knowing about, even though it's not part of
> today's event: some events include Live Round — a Kahoot-style quiz.
> Your host gives everyone a room code, you join solo or team up with
> classmates, answer questions on your phone, and see the results live
> together. Nothing to do with this yet — just so it's not a surprise the
> first time a club runs one."
...
**Say:**
> "Your Profile has your full activity history. And the Leaderboard ranks
> every student in the program — everyone shows up, even at zero points,
> so there's always something to climb toward."
...
it, show the form (don't actually submit on camera — just show the
screen).

**Say:**
> "Two things worth doing right now, not later. First — turn on
> notifications, right here on your Profile — you'll hear about new
> events the moment they're posted, and if anything changes about an
> event you've already registered for. Second — set your own password
> from 'Change password,' so it's something only you know."

**Callout to show on screen (text overlay, hold for a few extra seconds —
this is the most important thing in the whole video):**
> **Forgot your password?** Try "Forgot password" on the login screen
> first. If that doesn't work or you don't get the email, **contact the
> Synergy team directly** — don't just wait, reach out.

---

## Closing card (text overlay, no narration needed)

> **Synergy** — Progress, Together.
> One app. Every club. Every point counts.
>
...
- Shot 7's "forgot password → contact the Synergy team" callout should be
  ...
  knowledge.
- Wherever a student needs to actually reach someone — forgot password,
  account problems, anything not working — say **"contact the Synergy
  team,"** not "ask your club coordinator" or "ask your committee
  member." Those roles create/manage events, they're not the support
  contact.
